   ...
   return (
      <div className="bg-gray-800 rounded-lg p-5 w-5/12">
         ...
         <ul className="flex flex-col gap-6">
            <CategoriesItem iconName="food" spent={3427} total={10000} />
            <CategoriesItem iconName="house" spent={10000} total={15000} />
            <CategoriesItem iconName="sport" spent={1453} total={4000} />
            <CategoriesItem iconName="pet" spent={2750} total={3000} />
         </ul>
      </div>
   );
};
